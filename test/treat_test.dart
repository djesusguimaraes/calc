...
//     bool canConcatKleene = (currentCode == kleene.codeUnit) && (!nextIsOp || nextCode == open.codeUnit);
//     bool canConcatParentheses = (!currentIsOp && nextCode == open.codeUnit) || (currentCode == close.codeUnit && !nextIsOp);
//
