...
class OperatorsProvider {
  ...
  OperatorsProvider(this.values, {this.simbols});

  factory OperatorsProvider.fromJson(Map<String, dynamic> json) {
    Set<Operator> values = {};
    Set<String> simbols = {};
    ...
    return OperatorsProvider(values, simbols: simbols);
  }
  ...
  bool isOperator(String simbol) => simbols!.contains(simbol);
}
