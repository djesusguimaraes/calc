...
import '../domain/models/button_model.dart';
import '../domain/models/special_button_model.dart';
...
class _KeyBoardState extends State<KeyBoard> {
        ...
        body: SafeArea(
                      ...
                      children: [
                        Flexible(
                            ...
                            child: Consumer<ExpressionChangeNotifier>(
                              ...
                              _controller.text = value.expressionString;
                              return TextField(
          ...
          Container(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
                IconButton(
                    onPressed: context
                            .watch<ExpressionChangeNotifier>()
                            .expression
                            .isNotEmpty
                        ? notifier.backSpace
                        : null,
          ...
          GridView.builder(
              ...
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                  crossAxisCount: 4, childAspectRatio: .89),
              itemBuilder: (_, index) =>
                  _buttonsInstances.elementAt(index).render(context),
  ...
  Set<Button> _buildButtons() {
    ...
    customActions = {
      ...
      '=': () => notifier.evaluate(),
      'x': () => notifier.addValue('*'),
      '+/-': () => notifier.changeSign(_controller.selection.base.offset - 1),
